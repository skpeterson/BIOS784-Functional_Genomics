...
While some immune cells, such as microglia, have been investigated for their role in the development and progression of Alzheimer’s, the role of the peripheral immune cells has not been investigated in much depth. Learning more about these cells can potentially increase our understanding of disease etiology and pathogenesis. This study identified significant increases in chromatin accessibility and differential gene expression in peripheral immune cells of AD patients relative to healthy controls. They also found differences in chromatin accessibility and transcription based on APOE genotype. APOE (Apolipoprotein E) is a key risk gene for AD with three isoforms: APOE2, APOE3, and APOE4. For our study, we will focus on AD vs HC. 
